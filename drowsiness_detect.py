...
def detect():
    ...
    # detector = cv2.CascadeClassifier("haarcascade_frontalface_default.xml")  # Faster but less accurate then dlib 
...
label1 = Label(text="Wellcome to Drowsy Detection System", bg="red", fg="white", padx=4, pady=4,
...
f1.pack(side=BOTTOM)
label2 = Label(f1, text="Please Enter Q to stop the app", bg="green", fg="white", padx=4, pady=4,
               font=("comicsansms", 10, "bold"))
label2.pack()
